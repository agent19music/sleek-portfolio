            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 backdrop-blur-md bg-white/30 dark:bg-black/20 z-1000"
                    ...
                    <motion.div
                        ...
                        className="fixed inset-3 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:max-w-2xl sm:w-full z-1001 overflow-hidden rounded-2xl sm:rounded-3xl"
